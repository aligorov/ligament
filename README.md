...
| **Периферийные узлы Relay** | ❌ 0 шт (заблокировано) | ✅ Включены | **200 $** / узел на период | **500 $** / узел единовременно |
...
| **Синхронизация с Active Directory / LDAP (`ldap`)** | ❌ Нет | ✅ Да | ✅ Да | ✅ Да |
| **Удалённая помощь SOS / WebRTC (`support`)** | ❌ Нет | ✅ Да | ✅ Да | ✅ Да |
...
| Компонент | Платформа | Формат | Назначение |
|---|---|---|---|
